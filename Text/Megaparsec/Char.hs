...
newline :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
newline = char '\n'
{-# INLINE newline #-}
...
crlf :: forall e s m. (MonadParsec e s m, Element (Tokens s) ~ Char, Eq (Tokens s)) => m (Tokens s)
crlf = string (S.fromList "\r\n")
{-# INLINE crlf #-}

-- | Parse a CRLF (see 'crlf') or LF (see 'newline') end of line. Return the
-- sequence of characters parsed.

eol :: forall e s m. (MonadParsec e s m, Element (Tokens s) ~ Char, Eq (Tokens s)) => m (Tokens s)
eol = (opoint <$> newline)
  <|> crlf
  <?> "end of line"
{-# INLINE eol #-}
...
tab :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
tab = char '\t'
{-# INLINE tab #-}
...
space :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m ()
...
space1 :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m ()
...
controlChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
spaceChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
upperChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
upperChar = satisfy isUpper <?> "uppercase letter"
{-# INLINE upperChar #-}

-- | Parse a lower-case alphabetic Unicode character.

lowerChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
letterChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
alphaNumChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
printChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
printChar = satisfy isPrint <?> "printable character"
{-# INLINE printChar #-}

-- | Parse an ASCII digit, i.e between “0” and “9”.

digitChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
binDigitChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
octDigitChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
hexDigitChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
markChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
numberChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
punctuationChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
symbolChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
symbolChar = satisfy isSymbol <?> "symbol"
{-# INLINE symbolChar #-}

-- | Parse a Unicode space and separator characters.

separatorChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
asciiChar :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
latin1Char :: (MonadParsec e s m, Element (Tokens s) ~ Char) => m (Element (Tokens s))
...
charCategory :: (MonadParsec e s m, Element (Tokens s) ~ Char)
  => GeneralCategory
  -> m (Element (Tokens s))
...
char :: (MonadParsec e s m, Element (Tokens s) ~ Char) => Element (Tokens s) -> m (Element (Tokens s))
char = single
{-# INLINE char #-}
